...
export class MusicService{
    ...
    getMusic(): Observable<Imusic[]>{
        return this._http.get(this._musicUrl).pipe(map(this.extractData));
    }
    */

    //Using Promises
    /*
    getMusic(): Promise<Imusic[]>{
        return this._http.get(this._musicUrl).toPromise().then((res) => res.json());
    }
    */
}

/*
  below dataset was there previously in return part of getMusic() when _musicUrl was not defined:
